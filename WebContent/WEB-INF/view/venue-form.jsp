...
<html lang="pl">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
    ...
    <div class="container text-center">
 			...
 			<form:form action="saveVenue" modelAttribute="venue" method="post" cssClass="input-group mt-5 ml-5  ">
...
<tbody>
<tr>
<td><label>Nazwa miejsca</label></td>
<td><form:input path="venue_name"></form:input></td>
