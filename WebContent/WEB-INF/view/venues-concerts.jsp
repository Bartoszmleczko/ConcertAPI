  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
      					...
      					<h1 class="text-center text-uppercase text-secondary mb-0">Miejsca</h1>
      					<c:forEach items="${venuesList}" var="venue">
      					<div class="genreDivs col-lg-12" id="${venue.venue_name}">
      					<h2>${venue.venue_name}</h2>
      					
      					 <hr class="star-dark mb-5 ">
      					
      					<c:forEach items="${venue.concerts}" var = "con">
