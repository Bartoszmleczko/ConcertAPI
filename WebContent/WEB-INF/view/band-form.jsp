...
<html lang="pl">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
    ...
    <div class="container text-center">
 			...
 			<form:form action="saveBand1" modelAttribute="band" method="post" cssClass="input-group mt-5 ml-5  ">
 			<form:hidden path="band_id"/>
<table>

<tbody>
<tr>
<td><label>Nazwa zespołu</label></td>
<td><form:input path="band_name" class="form-control"></form:input></td>
</tr>
<tr>
<td><label>Opis zespołu</label></td>
<td><form:input path="description" class="form-control"></form:input></td>
</tr>

<form:form modelAttribute="date1" >
