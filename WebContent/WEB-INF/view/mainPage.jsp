...
<html lang="pl">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top new-height" style="color:#ffffff;">
    <div class="container">
      <a class="navbar-brand" href="mainPage">E-Concert.pl</a>
...
<div class="mt-5"></div>
  ...
  <!-- Page Content -->
<div class="container con-style rounded shadow-lg p-3 mb-5">
<c:forEach items="${concerts}" var="con">

<div class="row row-div rounded shadow-lg p-3 mb-5 ml-1" >





<div class="col-lg-5 ml-auto" style="float:left;">

		<img src="${pageContext.request.contextPath}/resources/img/gwiazdy/${con.band.band_img}" class="img-responsive" width=100% style="margin-top:auto;"/>
...
<div class="col-lg-3 ml-auto" style="float:left;" >


<span>${con.band.tour_desc}</span>
