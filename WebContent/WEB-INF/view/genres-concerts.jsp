  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
      					...
      					<h1 class="text-center text-uppercase text-secondary mb-0">Gatunki</h1>
      					<c:forEach items="${genresList}" var="genre">
      					<div class="genreDivs col-lg-12" id="${genre.genre_name}">
      					<h2>${genre.genre_name}</h2>
      					
      					 <hr class="star-dark mb-5 ">
      					
      					<c:forEach items="${genre.concerts}" var = "con">
      					<div class="row">
